...
In this paper, we used the lossy variable-bitrate Ogg Vorbis format.
...
When we ran LASSO regressions, we consistently found that two features were of the most predictive value: the RMS energy of a sound and the time homogeneity of the RMS energy. A linear regression with either one of these features had $R^2$ of, on average, $.45$ on the test set. 
